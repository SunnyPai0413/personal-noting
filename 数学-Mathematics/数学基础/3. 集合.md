...
4. 公式：
	...
	$\complement_U(\complement_UA) \implies \{x \in U | (x \in U) \land \neg ((x \in U) \land \neg (x \in A))\} \implies \{x \in U | (x \in U) \land (\neg(x \in U) \lor \neg \neg (x \in A))\}$
	 $\implies \{x \in U | (x \in U) \land (\neg(x \in U) \lor (x \in A))\} \implies \{x \in U | ((x \in U) \land \neg(x \in U)) \lor ((x \in U) \land (x \in A))\}$
	  $\implies \{x \in U | \varnothing \lor (x \in A)\} \implies A$
	   4. $\complement_M(A \cup B) = \complement_MA \cap \complement_MA$
## 集合描述、常见集合
1. 集合描述方式：
	1. 列举法：$\{1, 2, 3, 4, 5\}$
	2. 描述法：$\{x|P(x)\}$
